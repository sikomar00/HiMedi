...
public class GameNetworkManager : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        //sceneNetworkManager.GetComponent<SceneNetworkManager>();
        int myIdx = PhotonNetwork.CurrentRoom.PlayerCount - 1;
        Debug.Log("my Idx : " + myIdx);
        ...
        //playerCharacters[myIdx].SetActive(true);
